    ...
    def start_session(self, camera_index=0, show_preview=True, scale_frame=0.77, desired_fps=2, tolerance=0.45):
        ...
        try:
            ...
            while True:
                ...
                unknown_face_encodings = face_recognition.face_encodings(rgb_frame, face_locations, num_jitters=5, model="small") # Generate encodings of every faces in the frame in a list
